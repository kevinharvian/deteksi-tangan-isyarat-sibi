...
# ============================================
# 📁 Deteksi Dari Gambar (FITUR BARU)
# ============================================
st.markdown("---")
st.subheader("📁 Deteksi Dari Gambar")

uploaded_files = st.file_uploader(
    "Unggah satu atau lebih gambar tangan untuk diproses:",
    type=["jpg", "jpeg", "png"],
...
if uploaded_files:
    ...
    st.success("✅ Kalimat hasil deteksi dari gambar:")
    st.markdown(f"### `{kalimat_gambar}`")
